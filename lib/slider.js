  ...
  _createClass(Slider, [{
    ...
    value: function fr() {
      ...
      z.hanResize = function () {
        ...
        if (x != -1) {
          var bp = z.res[keys[x]];
          z.o = (bp === null || bp === void 0 ? void 0 : bp.show) || z.o;
      ...
      var startSwiping = function startSwiping(e) {
        ...
        if (e.clientX || e.touches) {
          var react = z.p.getBoundingClientRect(),
            ...
            z.txp = -100 / z.o * temCurInd - (temX - (e.clientX || e.touches[0].clientX) - react.x) / react.width * 100;
          ...
          z.fmt = function (e) {
            ...
            if (z.txp <= (z.a.length - z.o) * (-100 / z.o) || z.txp >= 0) {
              ...
              temCurInd = z.c;
              calPos(e); // z.txp = (-100 / z.o) * z.c;
            } // console.log(z.txp)


            z.s.style = "transform: translate3d(".concat(z.txp, "%, 0px, 0px);transition:0s");
          };
